            ...
            <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list"
              ...
              <a href="#" class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <p class="preview-subject ellipsis mb-1 text-small">@lang('message.Account settings')</p>
                </div>
              </a>
              ...
              <a href="#" class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <p class="preview-subject ellipsis mb-1 text-small">{{trans('message.Change password')}}</p>
                </div>
              </a>
              <div class="dropdown-divider"></div>
              <a href="#" class="dropdown-item preview-item">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url('products')}}">{{__('message.All products')}}</a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url('product/create')}}">{{__('message.Add new product')}}</a></li>
            </ul>
          </div>
        </li>
      </ul>
